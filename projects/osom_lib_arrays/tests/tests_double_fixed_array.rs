...
fn test_push_and_compare(#[case] data: &[i32]) {
    let mut inlined_vec = DoubleFixedArray::<_, 15, 15>::new();
    for value in data {
    ...
    let mut other = DoubleFixedArray::<_, 15, 15>::new();
    for value in data {
...
fn test_incremental_push() {
    ...
    let mut arr = DoubleFixedArray::<_, 150, 150>::new();
...
fn test_various_drops() {
    ...
    let mut arr = DoubleFixedArray::<_, MAX, MAX>::new();
...
#[test]
fn test_fill() {
    let mut arr = DoubleFixedArray::<_, 15, 15>::new();
...
fn test_out_of_range() {
    let mut arr = DoubleFixedArray::<_, 3, 1>::new();
    arr.push(1).unwrap();
    arr.push(2).unwrap();
    arr.push(3).unwrap();
    arr.push(4).unwrap();
    assert!(arr.push(5).is_err());
    assert_eq!(arr.pop().unwrap(), 4);
...
#[test]
fn test_out_of_range_2() {
    let mut arr = DoubleFixedArray::<_, 2, 2>::new();
    arr.push(1).unwrap();
    arr.push(2).unwrap();
    arr.push(3).unwrap();
    arr.push(4).unwrap();
...
#[test]
fn test_out_of_range_3() {
    let mut arr = DoubleFixedArray::<_, 1, 3>::new();
    arr.push(1).unwrap();
    arr.push(2).unwrap();
    arr.push(3).unwrap();
    arr.push(4).unwrap();
...
#[test]
fn test_push_on_boundary() {
    let mut arr = DoubleFixedArray::<_, 3, 7>::new();
    arr.extend_from_array([1]).unwrap();
