...
use crate::abseil::hash_table::abseil_layout::ABSEIL_BLOCK_SIZE;
...
{
    const CHECK: () = const {
        osom_lib_reprc::hidden::is_reprc::<*mut [u8; ABSEIL_BLOCK_SIZE]>();
        osom_lib_reprc::hidden::is_reprc::<*mut [KVP<TKey, TValue>; ABSEIL_BLOCK_SIZE]>();
    };
}
